...
The manifest (config/study_manifest.yaml at the study root) declares pipeline STRUCTURE —
...
structural companion to config/study_config.yaml (clinical parameters).
...
def manifest_path(study=None, root="."):
    ...
    `<root>/config/study_manifest.yaml`. Phase 2 extends this to resolve a named study
