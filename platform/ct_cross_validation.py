...
`03_metadata/adam/ADaM_spec.xlsx` 'Codelists' sheet -- the source of truth that drives
...
Usage:
  python3 platform/ct_cross_validation.py [--version 2026-03-27]
...
SPEC = os.path.join(ROOT, "03_metadata/adam", "ADaM_spec.xlsx")
