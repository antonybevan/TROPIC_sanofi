...
with N / events / KM-median computed here directly from `04_analysis_datasets/adam/adtte_prod.xpt`.
...
OUTPUT  (additive)
------------------
  05_outputs/ars/tropic_reporting_event.json   ARS v1.0 ReportingEvent instance
  05_outputs/ars/tropic_ard.csv                Analysis Results Dataset (tidy results)

Model basis: CDISC ARS v1.0 LinkML (cdisc-org.github.io/analysis-results-standard).
USAGE:  python3 platform/build_ars.py
...
OUT_DIR = os.path.join(ROOT, "05_outputs/ars")
DPM = 30.4375
