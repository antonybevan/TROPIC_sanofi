...
def build_validation_strategy_report(root, strategy_path, out_dir, report_path):
    ...
    lines = [
        ...
        "",
        "> This report evaluates `config/validation_strategy.yaml`: the machine-readable "
...
def main(argv=None):
    ...
    parser.add_argument("--strategy", default="config/validation_strategy.yaml")
    parser.add_argument("--out-dir", default="platform/validation_strategy")
