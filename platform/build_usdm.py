...
WHY
---
The package has a protocol PDF, SAP, and config/study_config.yaml, but no machine-readable
...
config/study_config.yaml + the public TROPIC protocol (NCT00417079 / EFC6193 / XRP6258).

OUTPUT:  03_metadata/usdm/tropic_usdm.json
USAGE:   python3 platform/build_usdm.py
"""
...
OUT = os.path.join(ROOT, "03_metadata/usdm", "tropic_usdm.json")
