...
#
# Reads the PRISTINE real source SDTM (01_source_data/real_sdtm/*.sas7bdat, the
...
# the git-ignored 08_submission_package/m5 tabulation copy. Source stays pristine.
# ==============================================================================
...
SRC <- file.path(ROOT, "01_source_data", "real_sdtm")
STG <- file.path(ROOT, ".core_run", "sdtm34")
M5  <- file.path(ROOT, "08_submission_package", "m5", "datasets", "tropic", "tabulations", "sdtm", "datasets")
...
# Canonical title-cased SDTM labels (mirror of 03_metadata/define/uplift_define_34.py LBL) so the
