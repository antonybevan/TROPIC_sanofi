...
STAGE_GATE_RULES = [
    ...
    ("Simulation Operating Characteristics", ["G02", "G06"], "governed data-free methods evaluation, precision accounting, and analytic benchmark"),
    ("Simulation MAP and Report", ["G07"], "JSON-bound informative simulation plan/report generation"),
    ("Simulation Evidence Independent Verification", ["G06", "G07"], "independent recomputation of simulation hashes, accounting, precision, acceptance, and reviewer-report parity"),
