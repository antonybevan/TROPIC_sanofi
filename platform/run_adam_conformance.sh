...
#
# Usage:  bash platform/run_adam_conformance.sh
# Outputs: 06_qc_evidence/conformance/adam_conformance_report.{csv,md}
#          + 06_qc_evidence/conformance/adam_conformance_status.json
set -euo pipefail
cd "$(dirname "$0")/.."
