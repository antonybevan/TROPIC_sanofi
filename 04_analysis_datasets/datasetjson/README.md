# 04_analysis_datasets/datasetjson — CDISC Dataset-JSON v1.1 transport layer
...
(`04_analysis_datasets/programs/sas/U_xpt_export.sas`). This layer closes that gap without touching
...
- These files are data-bearing and are excluded from the data-free `08_submission_package/m5` preview by
