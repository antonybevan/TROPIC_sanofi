...
%macro get_safe_path;
    ...
    %let SLSH = /;
    %let _sig = 04_analysis_datasets/programs/sas&SLSH.00_config.sas;
    ...
    %else %do;
        ...
        %if %sysfunc(fileexist(&_home/OneDrive/Desktop/TROPIC/04_analysis_datasets/programs/sas/00_config.sas)) %then
            %let safe_path = &_home/OneDrive/Desktop/TROPIC;
        %else %if %sysfunc(fileexist(&_home/Desktop/TROPIC/04_analysis_datasets/programs/sas/00_config.sas)) %then
