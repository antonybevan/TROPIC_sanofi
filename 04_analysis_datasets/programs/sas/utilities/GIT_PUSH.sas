...
%macro init_env;
    ...
    %else %if %sysfunc(fileexist(04_analysis_datasets/programs/sas/00_config.sas)) %then %include "04_analysis_datasets/programs/sas/00_config.sas";
    %else %if %sysfunc(fileexist(../04_analysis_datasets/programs/sas/00_config.sas)) %then %include "../04_analysis_datasets/programs/sas/00_config.sas";
    ...
    %else %do;
        ...
        %if %upcase(&SYSSCP) = WIN and %sysfunc(fileexist(&_home/OneDrive/Desktop/TROPIC/04_analysis_datasets/programs/sas/00_config.sas)) %then
            %include "&_home/OneDrive/Desktop/TROPIC/04_analysis_datasets/programs/sas/00_config.sas";
        %else %if %upcase(&SYSSCP) = WIN and %sysfunc(fileexist(&_home/Desktop/TROPIC/04_analysis_datasets/programs/sas/00_config.sas)) %then
            %include "&_home/Desktop/TROPIC/04_analysis_datasets/programs/sas/00_config.sas";
        %else %if %sysfunc(fileexist(&_home/TROPIC/04_analysis_datasets/programs/sas/00_config.sas)) %then
            %include "&_home/TROPIC/04_analysis_datasets/programs/sas/00_config.sas";
