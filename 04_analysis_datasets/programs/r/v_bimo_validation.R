...
#
# Scope/limitations are documented in 07_reviewer_explanation/guides/BDRG.md. In particular
...
haven::write_xpt(clinsite, "04_analysis_datasets/adam/clinsite_v.xpt", name = "CLINSITE")
cat(sprintf(
  "NOTE: [VALIDATION] Wrote validation CLINSITE: 04_analysis_datasets/adam/clinsite_v.xpt (%d sites)\n",
  nrow(clinsite)
))
