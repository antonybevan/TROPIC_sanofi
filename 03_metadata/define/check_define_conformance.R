...
# -----------------------------------------------------------------------------
# Assert that 03_metadata/define/define.xml CONFORMS TO the authoritative spec
...
#
# Usage:
#   Rscript 03_metadata/define/check_define_conformance.R            # gate
#   Rscript 03_metadata/define/check_define_conformance.R --self-test # prove teeth
# =============================================================================
...
run_gate <- function() {
  spec_path <- find_file("03_metadata/adam/ADaM_spec.xlsx")
  define_path <- find_file("03_metadata/define/define.xml")
  spec <- read_spec_grid(spec_path)
  def <- read_define_grid(define_path)
  findings <- compare(spec, def)

  report_dir <- find_file("platform/conformance")
