...
| Pinnacle 21 | Pinnacle 21 Community 4.1.0 executed with FDA engine 2508.1 and ADaMIG 1.3 (FDA); the exact run is recorded in `06_qc_evidence/conformance/p21_adam_runrecord.md`. | Informative only. Community is not Enterprise, is not licensed submission clearance, and the generated workbook itself reports an incompatible-CLI condition. |
