...
def _load_yaml(path):
    if yaml is None:
        raise RuntimeError("PyYAML is not importable; install pyyaml to read evidence_layers.yaml")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Validate evidence_layers.yaml")
    parser.add_argument("--path", default="evidence_layers.yaml",
