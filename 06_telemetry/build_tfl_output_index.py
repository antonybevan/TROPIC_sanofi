...
Controlled scope authority is tfl_output_catalog.yaml (SAP full catalog vs
...
CONTROLLED_CATALOG_PATH = "tfl_output_catalog.yaml"
...
CATALOG = {
    "F-01-1": {
        ...
        "class": "figure",
        "file": "09_tfl/output/figures/F-01-1_CONSORT_Disposition.png",
        "sas_companion": None,
        "sap_ref": "SAP v4.0 section 3",
        "adam_inputs": "ADSL",
        "generator": "09_tfl/tfl_generation.R population-flow builder",
    ...
    "F-11-1": {
        ...
        "class": "figure",
        "file": "09_tfl/output/figures/F-11-1_KM_OS.png",
        "sas_companion": "09_tfl/output/figures/sas/F-11-1_KM_OS_SAS.png",
        "sap_ref": "SAP v4.0 section 9",
        "adam_inputs": "ADTTE (OS), ADSL",
        "generator": "09_tfl/tfl_generation.R compute_tte_stats() / KM plot",
    ...
    "F-11-2": {
        ...
        "class": "figure",
        "file": "09_tfl/output/figures/F-11-2_KM_PFS.png",
        "sas_companion": "09_tfl/output/figures/sas/F-11-2_KM_PFS_SAS.png",
    ...
    "F-12-1": {
        ...
        "class": "figure",
        "file": "09_tfl/output/figures/F-12-1_Subgroup_Forest.png",
        "sas_companion": "09_tfl/output/figures/sas/F-12-1_Subgroup_Forest_SAS.png",
        "sap_ref": "SAP v4.0 section 8.2",
        "adam_inputs": "ADTTE (OS), ADSL covariates",
        "generator": "09_tfl/tfl_generation.R subgroup Cox model",
    ...
    "F-13-1": {
        ...
        "class": "figure",
        "file": "09_tfl/output/figures/F-13-1_PSA_Waterfall.png",
        "sas_companion": "09_tfl/output/figures/sas/F-13-1_PSA_Waterfall_SAS.png",
        "sap_ref": "SAP v4.0 section 5.2",
        "adam_inputs": "ADLB (PSA), ADSL",
        "generator": "09_tfl/tfl_generation.R PSA best-change waterfall",
    ...
    "F-14-1": {
        ...
        "class": "figure",
        "file": "09_tfl/output/figures/F-14-1_Swimmer_Plot.png",
        "sas_companion": "09_tfl/output/figures/sas/F-14-1_Swimmer_Plot_SAS.png",
        "sap_ref": "SAP v4.0 section 7.8",
        "adam_inputs": "ADEX, ADSL",
        "generator": "09_tfl/tfl_generation.R exposure swimmer plot",
    ...
    "F-17-1": {
        ...
        "class": "figure",
        "file": "09_tfl/output/figures/F-17-1_Optimus_Scatter.png",
        "sas_companion": "09_tfl/output/figures/sas/F-17-1_Optimus_Scatter_SAS.png",
        "sap_ref": "SAP v4.0 section 10",
        "adam_inputs": "ADEX (RDI), ADLB (ANC nadir)",
        "generator": "09_tfl/tfl_generation.R LOESS exposure-response scatter",
        "arm": "RD.OPTIMUS.ER",
    ...
    "T-11-6": {
        ...
        "class": "table",
        "file": "09_tfl/output/tables/T-11-Efficacy_Tables.txt",
        "sap_ref": "SAP v4.0 sections 4.3-5.3",
        "adam_inputs": "ADTTE",
        "generator": "09_tfl/tfl_generation.R secondary efficacy table block",
    ...
    "T-11-8": {
        ...
        "generator": "09_tfl/tfl_generation.R response summary block",
        "arm": "RD.EFFICACY.SECONDARY",
    ...
    "T-11-8b": {
        ...
        "generator": "09_tfl/tfl_generation.R response-evaluable sensitivity block",
    ...
    "T-17-1": {
        ...
        "class": "table",
        "file": "09_tfl/output/tables/T-17-Optimus_Tables.txt",
        "sap_ref": "Project Optimus demonstration (program comments); not in current traceability table",
        "adam_inputs": "ADEX, ADSL",
        "generator": "09_tfl/tfl_generation.R Project Optimus text table block",
        "arm": "not currently mapped in ARM",
    ...
    "T-20-1": {
        ...
        "class": "table",
        "file": "09_tfl/output/tables/T-20-AE_Summary_Tables.txt",
        "sap_ref": "SAP v4.0 section 7",
        "adam_inputs": "ADAE, ADSL",
        "generator": "09_tfl/tfl_generation.R AE summary block",
        "arm": "RD.SAFETY.TEAE",
    ...
    "T-20-2": {
        ...
        "sap_ref": "SAP v4.0 section 7",
        "adam_inputs": "ADAE, ADSL",
        "generator": "09_tfl/tfl_generation.R AE SOC table block",
        "arm": "RD.SAFETY.TEAE",
        "qc": "ADAE/ADSL reconciliation; TFL generation gate; output hash",
    },
    "T-21-1": {
        ...
        "class": "table",
        "file": "09_tfl/output/tables/T-21-Lab_Shift_Tables.txt",
        "sap_ref": "SAP v4.0 section 7.5",
        "adam_inputs": "ADLB, ADSL",
        "generator": "09_tfl/tfl_generation.R lab shift block",
...
def _pipeline_health_ts():
    path = "06_telemetry/pipeline_health.json"
...
def _load_controlled_catalog(path=CONTROLLED_CATALOG_PATH):
    if yaml is None:
        raise RuntimeError("PyYAML is required to load tfl_output_catalog.yaml")
    if not os.path.exists(path):
...
def main(argv=None):
    ...
    parser.add_argument("--output-root", default="09_tfl/output")
    parser.add_argument("--out-dir", default="06_telemetry/tfl_output_index")
