...
SPEC_PATH = ROOT / "00_specifications" / "ADaM_spec.xlsx"
DEFINE_PATH = ROOT / "07_define_xml" / "define.xml"
LINEAGE_PATH = ROOT / "metadata_lineage.yaml"
OUT_DIR = ROOT / "06_telemetry" / "metadata_lineage"
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--check", action="store_true", help="Fail if workbook predecessors differ from metadata_lineage.yaml")
