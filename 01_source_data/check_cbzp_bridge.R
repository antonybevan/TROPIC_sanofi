...
# Writes: platform/cbzp_bridge_status.json
# Run:    Rscript 01_source_data/check_cbzp_bridge.R   (from project root)
# ==============================================================================
suppressMessages(library(haven))

dir  <- "01_source_data/cbzp_reconstructed"
doms <- c("adsl", "adtte", "adae", "adlb", "adex", "adrs")
TOL  <- 1e-6
status_path <- "platform/cbzp_bridge_status.json"
...
if (overall != "PASS") {
  cat("FAIL: [BRIDGE-PARITY] synthetic CbzP .xpt has drifted from .rds -- re-run 01_source_data/export_cbzp_xpt.R\n")
  quit(status = 1)
}
