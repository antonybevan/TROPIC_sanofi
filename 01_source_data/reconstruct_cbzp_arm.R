...
#
# Output:  01_source_data/cbzp_reconstructed/
...
dir.create("01_source_data/cbzp_reconstructed", showWarnings = FALSE, recursive = TRUE)
...
adtte_mp <- haven::read_xpt("04_analysis_datasets/adam/adtte_v.xpt") %>% filter(TRT01P == "MP")
...
saveRDS(adsl_cbzp,  "01_source_data/cbzp_reconstructed/adsl_cbzp.rds")
saveRDS(adae_cbzp,  "01_source_data/cbzp_reconstructed/adae_cbzp.rds")
saveRDS(adtte_cbzp, "01_source_data/cbzp_reconstructed/adtte_cbzp.rds")
saveRDS(adex_cbzp,  "01_source_data/cbzp_reconstructed/adex_cbzp.rds")
saveRDS(adlb_cbzp,  "01_source_data/cbzp_reconstructed/adlb_cbzp.rds")
saveRDS(adrs_cbzp,  "01_source_data/cbzp_reconstructed/adrs_cbzp.rds")

log_lines <- c(log_lines,
  "",
  "Output files:",
  "  01_source_data/cbzp_reconstructed/adsl_cbzp.rds",
  "  01_source_data/cbzp_reconstructed/adae_cbzp.rds",
  "  01_source_data/cbzp_reconstructed/adtte_cbzp.rds",
  "  01_source_data/cbzp_reconstructed/adex_cbzp.rds",
  "  01_source_data/cbzp_reconstructed/adlb_cbzp.rds",
...
writeLines(log_lines, "01_source_data/cbzp_reconstructed/reconstruction_log.txt")

cat("NOTE: [RECONSTRUCT] Done. All CbzP datasets saved to 01_source_data/cbzp_reconstructed/\n")
cat("      Validate with: cat('01_source_data/cbzp_reconstructed/reconstruction_log.txt')\n")
