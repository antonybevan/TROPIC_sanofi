...
rows = []
rows += compare("ADaM", ROOT / "03_metadata/define/define.xml", ROOT / "04_analysis_datasets/adam", "_prod.xpt")
...
adam_model = define_model(ROOT / "03_metadata/define/define.xml", require_methods=True)
adam_actual = {
    p.stem.removesuffix("_prod").upper(): p
    for p in (ROOT / "04_analysis_datasets/adam").glob("*_prod.xpt")
...
rows += compare(
    "SDTM", ROOT / "03_metadata/define/define_sdtm.xml",
    ROOT / "08_submission_package/ectd/0000/m5/datasets/tropic/tabulations/sdtm/datasets",
    require_methods=False,
)

out = ROOT / "06_qc_evidence/audit/metadata_data_drift.csv"
