...
WB = load_workbook(ROOT / "03_metadata/adam/ADaM_spec.xlsx", read_only=True, data_only=True)
...
try:
    import pyreadstat
    for path in (ROOT / "04_analysis_datasets/adam").glob("*_prod.xpt"):
...
producers = {
    "ADSL": ("04_analysis_datasets/programs/sas/A_adsl_generation.sas", "04_analysis_datasets/programs/r/v_adsl_validation.R"),
    "ADEX": ("04_analysis_datasets/programs/sas/A_adex_generation.sas", "04_analysis_datasets/programs/r/v_adex_validation.R"),
    "ADCM": ("04_analysis_datasets/programs/sas/A_adcm_generation.sas", "04_analysis_datasets/programs/r/v_adcm_validation.R"),
    "ADAE": ("04_analysis_datasets/programs/sas/A_adae_io_respec.sas", "04_analysis_datasets/programs/r/v_adae_io_validation.R"),
    "ADLB": ("04_analysis_datasets/programs/sas/A_adlb_generation.sas", "04_analysis_datasets/programs/r/v_adlb_validation.R"),
    "ADRS": ("04_analysis_datasets/programs/sas/A_adrs_generation.sas", "04_analysis_datasets/programs/r/v_adrs_validation.R"),
    "ADTTE": ("04_analysis_datasets/programs/sas/A_adtte_generation.sas", "04_analysis_datasets/programs/r/v_adtte_validation.R"),
}
tfl = {
...
out = ROOT / "06_qc_evidence/audit/adam_variable_traceability.csv"
