...
#   dataset to 04_analysis_datasets/adam/forest_hr_prod.csv during the ODA render; here the R track
...
sas_path <- "04_analysis_datasets/adam/forest_hr_prod.csv"
status_path <- "platform/forest_reconciliation_status.json"
...
er <- rbind(
  read_arm("04_analysis_datasets/adam/adtte_v.xpt", "04_analysis_datasets/adam/adsl_v.xpt", haven::read_xpt),
  read_arm("01_source_data/cbzp_reconstructed/adtte_cbzp.rds",
           "01_source_data/cbzp_reconstructed/adsl_cbzp.rds", readRDS)
)
