...
#   PROC LIFETEST (exported to 04_analysis_datasets/adam/tte_stats_prod.csv during the ODA run); here
...
sas_path <- "04_analysis_datasets/adam/tte_stats_prod.csv"
status_path <- "platform/results_reconciliation_status.json"
...
adtte <- haven::read_xpt("04_analysis_datasets/adam/adtte_v.xpt")
