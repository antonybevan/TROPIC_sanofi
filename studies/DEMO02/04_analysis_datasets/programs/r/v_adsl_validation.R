...
dir.create("04_analysis_datasets/adam", showWarnings = FALSE, recursive = TRUE)
...
write_xpt(adsl, "04_analysis_datasets/adam/adsl_v.xpt")
cat(sprintf("NOTE: [DEMO02] wrote 04_analysis_datasets/adam/adsl_v.xpt (%d subjects)\n", nrow(adsl)))
