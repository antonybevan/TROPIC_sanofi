...
/* ==============================================================================
   ...
   Output: adam.clinsite -> 04_analysis_datasets/adam/clinsite_prod.xpt
   ...
   SCOPE / HONEST LIMITATIONS (see 07_reviewer_explanation/guides/BDRG.md):
...
libname _xout xport "&PROJ_ROOT.&PATH_SEP.04_analysis_datasets/adam&PATH_SEP.clinsite_prod.xpt";
data _xout.clinsite;
    set adam.clinsite;
run;
libname _xout clear;
